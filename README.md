...
- ### Arrays
    ...
    - [ ] Implement a vector (mutable array with automatic resizing):
        - https://github.com/rust-lang/rust/blob/master/src/librustc_data_structures/array_vec.rs
...
- ### Queue
    ...
    - [ ] Implement using fixed-sized array:
        ...
        - [ ] empty()
        - [ ] full()
    - [ ] Implement with 2 arrays implement FIFO with amortized complexity O(1)
        - [ ] enqueue(value)
        - [ ] dequeue()
        - [ ] empty()
    - [x] Cost:
...
- ### Hash table <<< NEXT
    ...
    - [ ] implement with array using linear probing
        ...
        - get(key)
        - remove(key)
    - [ ] implement with array using separate chain
        - hash(k, m) - m is size of hash table
        - add(key, value) - if key already exists, update value
        - exists(key)
        - get(key)
...
- ### Dynamic Programming
    ...
    - [ ] Articles:
        ...
        - [ ] [Bitmasking and Dynamic Programming 1](https://www.geeksforgeeks.org/bitmasking-and-dynamic-programming-set-1-count-ways-to-assign-unique-cap-to-every-person/)
        - [ ] [Bitmasking and Dynamic Programming 2](https://www.geeksforgeeks.org/bitmasking-dynamic-programming-set-2-tsp/)
...
## Code Challenges to Solve:
- [Goolge Code Jam](https://code.google.com/codejam/)
